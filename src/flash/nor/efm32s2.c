...
#define EFM32_FLASH_BASE_G28            (EFM32_FLASH_BASE_G23)
...
#define EFM32_CMU_REG_CLKEN1_MSC_MSK_G28 (EFM32_CMU_REG_CLKEN1_MSC_MSK_G23)
...
static int efm32x_probe(struct flash_bank *bank)
{
	...
	} else if(efm32_mcu_info->part_family_num == 28) {
		base_address = EFM32_FLASH_BASE_G28;
	}
	...
	if (efm32_mcu_info->part_family_num == 22) {
		...
		msc_clken = EFM32_CMU_REG_CLKEN1_MSC_MSK_G28;
	} else {
